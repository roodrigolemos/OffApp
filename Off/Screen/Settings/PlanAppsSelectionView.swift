//
//  PlanAppsSelectionView.swift
//  Off
//

import SwiftUI

struct PlanAppsSelectionView: View {
...
private extension PlanAppsSelectionView {
    ...
    var headerSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("Pick the apps this plan applies to")
    ...
    var ctaSection: some View {
        Button {
            planManager.changePlan(preset: preset, selectedApps: selectedApps)
            dismissFlow = false
        } label: {
            Text("Save")
